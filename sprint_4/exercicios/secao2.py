...
"""
E3- A função calcula_saldo recebe uma lista de tuplas, correspondendo a um conjunto de lançamentos bancários.
...
def calcula_saldo(lancamentos) -> float:
    ...
    def rdc(tupla):
        total = reduce(lambda total, v: total - v[0] if v[1] == 'D' else total + v[0], lancamentos, 0)
        return total
    
    total = list(map(rdc, lancamentos))

    return total[0]

lancamentos = [(10, 'D'), (300, 'C'), (20, 'C'), (80, 'D'), (300, 'D')]
